...
class FlutterVoipAudioRouteManagerAndroid
    extends MethodChannelVoipAudioRouteManager {
  /// Registers this class as the default instance of [VoipAudioRouteManagerPlatform].
  static void registerWith() {
    VoipAudioRouteManagerPlatform.instance =
        FlutterVoipAudioRouteManagerAndroid();
  }
}
